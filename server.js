...
async function handleTelegramUpdate(update) {
  ...
  if (text.startsWith("/start")) {
    const intro =
      "Top Form — 3D калькулятор объёма моделей для ювелиров.\n" +
      "Быстро считает объём STL в см³, вес восковки и показывает габариты модели.\n" +
      "Есть пакетная загрузка, автоматический скриншот и удобное управление одной рукой.\n\n" +
      "Как пользоваться:\n" +
      "1) Нажмите кнопку «Открыть калькулятор».\n" +
      "2) Загрузите STL (можно несколько файлов).\n" +
      "3) Выберите модель в списке и получите объём, вес и PNG‑скриншот.\n\n" +
      "Используя бота, вы соглашаетесь получать редкие обновления и рассылки.";
